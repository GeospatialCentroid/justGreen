...
#   # inputs
#   ctFiles <- list.files(
#     path = "data/processed/summaryNDVI",
#     pattern = "_2023NDVI.csv",
#     full.names = TRUE
#   ) |>
#     read_csv() |>
...
#   ctFiles$countyGEOID <- stringr::str_sub(
#     string = ctFiles$geoid,
#     start = 1,
#     end = 5
#   )
#   # population data
...
# countyMortality <- read_csv("data/raw/mortality/All Cause of Death 2023.csv") |>
#   dplyr::mutate(
#     countyGEOID = as.character(`County Code`),
#     mortalityRate = as.numeric(`Crude Rate`) / 100000
#   ) |>
#   dplyr::mutate(
#     countyGEOID = case_when(
...
# # Dementia ----------------------------------------------------------------
# demData <- read_csv("data/raw/dementia/Dementia_55.csv") |>
#   dplyr::select(state = location, DementiaRate = val) |>
...
# # Stroke ------------------------------------------------------------------
# strokeData <- read_csv("data/raw/stroke/Stroke Incidence 2021.csv") |>
#   dplyr::select(state = location, StrokeRate = val) |>
...
#       ndviVal = meanNDVI,
#       baseNDVI = baseNDVI,
#       doseResponse = drfMortality_low
#     ),
#     rr_Mortality_high = relativeRateMortality(
#       ndviVal = meanNDVI,
#       baseNDVI = baseNDVI,
#       doseResponse = drfMortality_high
#     ),
#     paf_Mortality = populationAttributableFraction(rr_Mortality),
#     paf_Mortality_low = populationAttributableFraction(rr_Mortality_low),
#     paf_Mortality_high = populationAttributableFraction(rr_Mortality_high),
#     ls_Mortality = expectedIncidence(popOver20_2023, mortalityRate) |>
#       livesSaved(paf_Mortality),
#     ls_Mortality_low = expectedIncidence(popOver20_2023, mortalityRate) |>
#       livesSaved(paf_Mortality_low),
#     ls_Mortality_high = expectedIncidence(popOver20_2023, mortalityRate) |>
#       livesSaved(paf_Mortality_high),
...
#     paf_Mortality_low10 = populationAttributableFraction(rr_Mortality_low10),
#     paf_Mortality_high10 = populationAttributableFraction(rr_Mortality_high10),
#     ls_Mortality10 = expectedIncidence(popOver20_2023, mortalityRate) |>
#       livesSaved(paf_Mortality10),
#     ls_Mortality_low10 = expectedIncidence(popOver20_2023, mortalityRate) |>
#       livesSaved(paf_Mortality_low10),
#     ls_Mortality_high10 = expectedIncidence(popOver20_2023, mortalityRate) |>
#       livesSaved(paf_Mortality_high10),
...
#     ls_Mortality_Change_low_Rate = (ls_Mortality_Change_low / popOver20_2023) *
#       100000,
#     ls_Mortality_Change_high_Rate = (ls_Mortality_Change_high /
#       popOver20_2023) *
#       100000,

#     # stroke - uses pop over 35
#     rr_Stroke = relativeRateStrokeDem(
#       ndviVal = meanNDVI,
#       baseNDVI = baseNDVI,
#       doseResponse = doseResponseStroke
#     ),
#     rr_Stroke_low = relativeRateStrokeDem(
#       ndviVal = meanNDVI,
#       baseNDVI = baseNDVI,
#       doseResponse = drfStroke_low
#     ),
#     rr_Stroke_high = relativeRateStrokeDem(
#       ndviVal = meanNDVI,
#       baseNDVI = baseNDVI,
#       doseResponse = drfStroke_high
#     ),
#     paf_Stroke = populationAttributableFraction(rr_Stroke),
#     paf_Stroke_low = populationAttributableFraction(rr_Stroke_low),
#     paf_Stroke_high = populationAttributableFraction(rr_Stroke_high),
#     ls_Stroke = expectedIncidence(popOver35_2023, StrokeRate) |>
#       livesSaved(paf_Stroke),
#     ls_Stroke_low = expectedIncidence(popOver35_2023, StrokeRate) |>
#       livesSaved(paf_Stroke_low),
#     ls_Stroke_high = expectedIncidence(popOver35_2023, StrokeRate) |>
#       livesSaved(paf_Stroke_high),
...
#     paf_Stroke_low10 = populationAttributableFraction(rr_Stroke_low10),
#     paf_Stroke_high10 = populationAttributableFraction(rr_Stroke_high10),
#     ls_Stroke10 = expectedIncidence(popOver35_2023, StrokeRate) |>
#       livesSaved(paf_Stroke10),
#     ls_Stroke_low10 = expectedIncidence(popOver35_2023, StrokeRate) |>
#       livesSaved(paf_Stroke_low10),
#     ls_Stroke_high10 = expectedIncidence(popOver35_2023, StrokeRate) |>
#       livesSaved(paf_Stroke_high10),
...
#     ls_Stroke_Change_low_Rate = (ls_Stroke_Change_low / popOver35_2023) *
#       100000,
#     ls_Stroke_Change_high_Rate = (ls_Stroke_Change_high / popOver35_2023) *
#       100000,
...
#       ndviVal = meanNDVI,
#       baseNDVI = baseNDVI,
#       doseResponse = doseResponseDementia
#     ),
#     rr_Dementia_low = relativeRateStrokeDem(
#       ndviVal = meanNDVI,
#       baseNDVI = baseNDVI,
#       doseResponse = drfDementia_low
#     ),
#     rr_Dementia_high = relativeRateStrokeDem(
#       ndviVal = meanNDVI,
#       baseNDVI = baseNDVI,
#       doseResponse = drfDementia_high
#     ),
#     paf_Dementia = populationAttributableFraction(rr_Dementia),
#     paf_Dementia_low = populationAttributableFraction(rr_Dementia_low),
#     paf_Dementia_high = populationAttributableFraction(rr_Dementia_high),
#     ls_Dementia = expectedIncidence(popOver55_2023, DementiaRate) |>
#       livesSaved(paf_Dementia),
#     ls_Dementia_low = expectedIncidence(popOver55_2023, DementiaRate) |>
#       livesSaved(paf_Dementia_low),
#     ls_Dementia_high = expectedIncidence(popOver55_2023, DementiaRate) |>
#       livesSaved(paf_Dementia_high),
...
#     ),
#     paf_Dementia10 = populationAttributableFraction(rr_Dementia10),
#     ls_Dementia10 = expectedIncidence(popOver55_2023, DementiaRate) |>
#       livesSaved(paf_Dementia10),
...
#     ),
#     paf_Dementia_low10 = populationAttributableFraction(rr_Dementia_low10),
#     ls_Dementia_low10 = expectedIncidence(popOver55_2023, DementiaRate) |>
#       livesSaved(paf_Dementia_low10),
...
#     ),
#     paf_Dementia_high10 = populationAttributableFraction(rr_Dementia_high10),
#     ls_Dementia_high10 = expectedIncidence(popOver55_2023, DementiaRate) |>
#       livesSaved(paf_Dementia_high10),
...
#     ls_Dementia_Change_low_Rate = (ls_Dementia_Change_low / popOver55_2023) *
#       100000,
#     ls_Dementia_Change_high_Rate = (ls_Dementia_Change_high / popOver55_2023) *
#       100000,
#   ) |>
#   st_drop_geometry()
...
# readr::write_csv(
#   allCT_2,
#   "data/products/healthMeasures/allCT_2023_morDemStroke_with10percentAdjust.csv"
# )

# # add the social vulerability elements too the dataset
# sli <- list.files("data/raw/socialVul", full.names = TRUE) |>
#   readr::read_csv() |>
